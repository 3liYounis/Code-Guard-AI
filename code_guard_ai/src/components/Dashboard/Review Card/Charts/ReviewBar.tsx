...
const mapCodeReviewToBar = (codeReview: CodeReview) => {
  return useChart({
    ...
    data: [
      {
        name: "Security",
        value: codeReview.security,
        color: getColor(codeReview.security),
      },
      {
        name: "Cleanliness",
        value: codeReview.cleanliness,
        color: getColor(codeReview.cleanliness),
      },
      {
        name: "Maintainability",
        value: codeReview.maintainability,
        color: getColor(codeReview.maintainability),
      },
    ],
  });
};
